...
import basic.boardproject.dto.HashtagDto;
...
import basic.boardproject.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenSearchKeyword_whenRequestingSearchingArticleView_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @Test
    public void givenNothing_whenRequestingArticleView_thenRedirectingLoginView() throws Exception {
    ...
    @WithUserDetails(value = "jujuTest", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
